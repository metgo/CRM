...
const S: Record<string, Bi> = {
  ...
  g_messaging: { he: "תקשורת", en: "Messaging" },
  g_classic: { he: "CRM קלאסי", en: "CRM classic" },
  communications: { he: "היסטוריית תקשורת", en: "Communication history" },
  templates: { he: "תבניות הודעה", en: "Message templates" },
  reminders: { he: "תזכורות", en: "Reminders" },
  classicClients: { he: "מועצות (קלאסי)", en: "Councils (classic)" },
  classicContacts: { he: "אנשי קשר (קלאסי)", en: "Contacts (classic)" },
  classicDashboard: { he: "דשבורד קלאסי", en: "Classic dashboard" },
